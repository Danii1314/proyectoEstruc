...
public class Gimnasio implements GestionPersona{
    ...
    public void mostrarRutinaDiaria(String id) {
        Persona persona = buscarPersona(id);
        if (persona != null && persona instanceof Cliente) {
            Cliente cliente = (Cliente) persona;
            System.out.println("Rutina diaria para " + cliente.getNombre() + ":");
            System.out.println(cliente.obtenerRutinaDiaria());
        } else {
            System.out.println("Cliente no encontrado o ID no corresponde a un cliente");
        }
    }
}
